...
public class RuguloGrafico extends PersonajeGrafico{
	...
	public RuguloGrafico(int velocidad, int x, int y) {
		super(velocidad, x, y);
		this.image[0] = new ImageIcon(this.getClass().getResource("/Imagenes/rugulo.jpg"));
		this.image[1] = new ImageIcon(this.getClass().getResource("/Imagenes/rugulo.jpg"));
		this.image[2] = new ImageIcon(this.getClass().getResource("/Imagenes/rugulo.jpg"));
		this.image[3] = new ImageIcon(this.getClass().getResource("/Imagenes/rugulo.jpg"));
	}
}